...
[CustomPropertyDrawer(typeof(DungeonSystem))]
public class SystemPropertyDrawer : PropertyDrawer
{
    ...
    {
        SelectImplementationAttribute typeAttribute = new SelectImplementationAttribute(typeof(DungeonSystem));
        

        TryCacheTypesLogic.Execute(editorData, typeAttribute);
        TryCacheSystemNamesLogic.Execute(editorData, typeAttribute);
...
public static class TryCacheSystemNamesLogic
{
    //Effect-only version
