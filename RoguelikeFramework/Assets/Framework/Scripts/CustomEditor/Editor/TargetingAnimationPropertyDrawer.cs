...
[CustomPropertyDrawer(typeof(TargetingAnimation))]
public class TargetingAnimationPropertyDrawer : PropertyDrawer
{
    ...
    {
        SelectImplementationAttribute typeAttribute = new SelectImplementationAttribute(typeof(TargetingAnimation));
        

        TryCacheTypesLogic.Execute(editorData, typeAttribute);
        TryCacheAnimationNamesLogic.Execute(editorData, typeAttribute);
...
public static class TryCacheAnimationNamesLogic
{
    //Effect-only version
