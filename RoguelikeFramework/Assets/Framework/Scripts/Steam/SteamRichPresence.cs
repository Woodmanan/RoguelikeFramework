...
/*
 * Player only effect that handles the steam rich presence.
 */

[Group("Steamworks")]
[Priority(200)]
public class SteamRichPresence : Effect
{
    ...
    public override void Connect(Connections c)
    {
        ...
        c.OnTurnEndGlobal.AddListener(200, OnTurnEndGlobal);

        c.OnDeath.AddListener(200, OnDeath);
