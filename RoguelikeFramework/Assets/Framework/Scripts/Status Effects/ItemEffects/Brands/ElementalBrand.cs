...
[Group("Weapon Brands")]
[Priority(10)]
public class ElementalBrand : Effect
{
    public DamagePairing primaryDamage;

    public DamagePairing secondaryDamage;

    public DamagePairing perEnchant;
    ...
    {
        return connectedTo.item.enchantment * perEnchant.damage.evaluate();
    }
