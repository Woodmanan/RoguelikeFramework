...
public class Blink : Ability
{
    ...
    public override IEnumerator OnCast(Monster caster)
    {
        ...
        if (landingZoneOnly)
        {
            ...
            {
                goalTile.currentlyStanding.Damage(caster, damage.Evaluate(), DamageType.MAGICAL, DamageSource.ABILITY);
            }
        }
        else
        {
            ...
            {
                hit.Damage(caster, damage.Evaluate(), DamageType.MAGICAL, DamageSource.ABILITY);
            }
        }
