...
//[EffectGroup("P")]
[Priority(10)]
public class PlayerPassive : Effect
{
    public Stats statsPer100TurnsSafe;
    public Stats statsPer100TurnsCombat;

    public int TurnsTillSafety = 15;
    int currentCombatTurns;
    ...
    {
        if (currentCombatTurns > 0)
        {
            currentCombatTurns--;
            connectedTo.monster.AddBaseStats(statsPer100TurnsCombat / 100f);
        }
        else
        {
            connectedTo.monster.AddBaseStats(statsPer100TurnsSafe / 100f);
        }
    }
