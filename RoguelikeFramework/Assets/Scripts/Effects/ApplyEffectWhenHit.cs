...
[Priority(10)]
public class ApplyEffectWhenHit : Effect
{
    [SerializeReference]
    ...
    public bool applyOncePerAttack;
    ...
    public override void Connect(Connections c)
    {
        ...
        c.OnStartAttackTarget.AddListener(10, OnStartAttackTarget);
