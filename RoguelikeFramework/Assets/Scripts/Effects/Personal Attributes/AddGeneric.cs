...
[Priority(10)]
public class AddGeneric : Effect
{
    public List<Ability> abilitiesToAdd;
    [SerializeReference]
    public List<Effect> effectsToAdd;
    ...
    public override void OnConnection()
    {
        ...
        {
            connectedTo.monster.abilities.AddAbilityInstantiate(ability);
        }

        foreach (Effect effect in effectsToAdd)
        {
            connectedTo.monster.AddEffectInstantiate(effect);
        }
