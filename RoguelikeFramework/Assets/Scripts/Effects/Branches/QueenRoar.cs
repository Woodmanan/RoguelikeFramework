...
[Group("Branch/Hive")]
[Priority(10)]
public class QueenRoar : Effect
{
    public float healthToCall;
    ...
    public void CheckRoar(Monster target)
    {
    ...
    public override void Connect(Connections c)
    {
        ...
        c.OnHitByAbility.AddListener(10, OnHitByAbility);
