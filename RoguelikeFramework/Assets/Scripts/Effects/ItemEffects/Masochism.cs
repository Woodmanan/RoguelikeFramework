...
[Priority(10)]
public class Masochism : Effect
{
    [HideInInspector] public int counter = 0;
    public int triggersEvery = 1;
    [Range(0, 100)]
    public float efficiency;
    public Resources grantedResource;
    ...
    public void RegisterStartAttack()
    {
        counter++;
        if (counter >= triggersEvery)
        {
            active = true;
            counter %= triggersEvery;
        }
    }

    public void RegisterEndAttack()
    {
        active = false;
    }
