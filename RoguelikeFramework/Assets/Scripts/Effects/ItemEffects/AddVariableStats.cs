...
[Priority(10)]
public class AddVariableStats : Effect
{
    public float lowerPercent;
    public Stats lowerStats;

    public float higherPercent;
    public Stats higherStats;

    public Resources amount;
    public Resources fromMax;
