...
public class Healing : Effect
{
    ...
    public override string GetDescription()
    {
        ...
        values.Add("instant", Mathf.RoundToInt(instantHealth));
        values.Add("perTurn", Mathf.RoundToInt(healingPerTurn));
        values.Add("numTurns", Mathf.RoundToInt(numTurns));
    ...
    {
        connectedTo.monster.Heal(healingPerTurn);
        numTurns--;
        if (numTurns == 0)
        {
            Disconnect();
