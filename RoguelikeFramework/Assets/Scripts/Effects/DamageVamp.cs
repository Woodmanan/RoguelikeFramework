...
[Priority(10)]
public class DamageVamp : Effect
{
    public DamageType drainsOn;
    public DamageSource drainsFrom;
    [Range(0, 100)]
    ...
    {
        if ((damageType & drainsOn) > 0 && (source & drainsFrom) > 0)
        {
            connectedTo.monster?.Heal(damage * efficiency / 100f, false);
        }
    }
